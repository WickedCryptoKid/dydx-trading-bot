...
class BotAgent:
    ...
    # Primary function of BotAgent is opening and checking order status
    # Initialize class
    ...
    def __init__(
        ...
        # Pair status are FAILED / LIVE / CLOSE / ERROR
        self.order_dict = {
            'market_1': market_1,
            'market_2': market_2,
    ...
    def check_order_status_by_id(self, order_id):
            ...
            if order_status == 'CANCELED': # <-- has to be spelled as CANCELED here
            ...
            if order_status != 'FAILED':
                ...
                if order_status != 'FILLED':
                    self.client.private.cancel_ordere(order_id = order_id)
    ...
    def open_trades(self):
        ...
        # Print status - Opening 1st Order
        print('---')
        ...
        # Print status - Opening 2nd Order
        print('---')
        ...
        if order_status_m2 != 'live':
             ...
             try:
                  close_order = place_market_order(
                       self.client,
                       market = self.market_1,
                       side = self.quote_side, # close the order we use the side of quote order - the Opposite, ie. sell for old buy order
                       size = self.base_size,
