...
def manage_trade_exits(client):
  ...
  for position in open_positions_dict:
    ...
    if CLOSE_AT_ZSCORE_CROSS:
      ...
      # above combined check was Z score a positive and now crossed 0 to negative? vice versa
    ...
    if is_close: 
      ...
      if position_side_m1 == "SELL":
        side_m1 = "BUY" # closing position is buy for sell position
      ...
      try:
        ...
        close_order_m1 = place_market_order(
          ...
          reduce_only=True, # this needs to be true for closing positions 
        )
