...
from constants import RESOLUTION, FIND_COINTEGRATED, PLACE_TRADES
...
def get_candles_recent(client, market):
    ...
    # construct adn return price series
...
def construct_market_prices(client):
    ...
    # You can limit the amount to loop through here to save the time in development
